...
style default:
    properties gui.text_properties() ### nao mexe ##
...
screen main_menu():
    ...
    fixed:
        ...
        if main_menu:
            ...
            imagebutton auto "gui/mm_jogar_%s.png" xpos 778 ypos 863 action Start()
        ...
        #textbutton _("Carregar") action ShowMenu("load")
        imagebutton auto "gui/mm_carregar_%s.png" xpos 1503 ypos 894 action ShowMenu("load")


        #textbutton _("Preferências") action ShowMenu("preferences")
        imagebutton auto "gui/mm_preferencias_%s.png" xpos 498 ypos 887 action ShowMenu("preferences")
        ...
        #textbutton _("Sobre") action ShowMenu("about")
        imagebutton auto "gui/mm_sobre_%s.png" xpos 1241 ypos 890 action ShowMenu("about")
        ...
        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
            ...
            ## A ajuda não é necessária ou relevante para dispositivos móveis.
            #textbutton _("Ajuda") action ShowMenu("help")
            imagebutton auto "gui/mm_ajuda_%s.png" xpos 266 ypos 887 action ShowMenu("help")
        ...
        if renpy.variant("pc"):
            ...
            ## Web.
            #textbutton _("Sair") action Quit(confirm=not main_menu)
            imagebutton auto "gui/mm_sair_%s.png" xpos 1765 ypos 70 action Quit(confirm=not main_menu)
